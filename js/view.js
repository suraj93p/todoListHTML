...
(function (window) {
    ...
    View.prototype._completeItem = function (id) {
        ...
        if (elem) {
            //Add complete class css to child here
            // this.$todoList.removeChild(elem);
            Array.from(this.$todoList.children).forEach(function (childNode) {
                if (childNode === elem) {
                    if (childNode.classList.contains('completedItem')) {
                        childNode.classList.remove('completedItem');
                    } else {
                        childNode.classList.add('completedItem');
                    }
                }
            });
        }
